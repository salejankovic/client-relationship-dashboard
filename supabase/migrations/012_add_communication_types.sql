...
-- New types: online_call, sms_whatsapp, email_reply, followup_sent
...
CHECK (type IN ('email', 'call', 'meeting', 'note', 'linkedin', 'online_call', 'sms_whatsapp', 'email_reply', 'followup_sent'));
